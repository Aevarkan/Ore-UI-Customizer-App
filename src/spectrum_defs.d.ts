...
declare namespace Spectrum {
    interface Options {
         ...
         *
         * @param color The currently selected color of the color picker.
         * @param element The element that triggered the color picker. (Added by 8Crafter)
         * @return `false` to prevent the color picker from showing up.
         */
        // eslint-disable-next-line @typescript-eslint/no-invalid-void-type
        beforeShow?: ((color: tinycolor.Instance, element: HTMLElement) => boolean | void) | undefined;
    }
     ...
     */
    type ColorFormatName = "hex" | "hex3" | "hex8" | "hsl" | "rgb" | "hsb" | "name";
